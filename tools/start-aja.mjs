...
if (!python) {
  console.error('[AJA] Python was not found. Install Python 3.12+ or fix the Windows Python launcher, then run this again.');
...
children.push(
  spawnService('Dashboard', 'npm', ['run', 'dev', '-w', '@agentx/dashboard'], { env }),
);
