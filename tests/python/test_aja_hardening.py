...
from aja.self_evolve.reflection import evaluate_postconditions, reflect
from aja.utils.agentx_guard import AJAGuard
...
HARDENED_FILES = [
    ...
    PROJECT_ROOT / "libs" / "aja-core" / "aja" / "self_evolve" / "reflection.py",
    ...
    PROJECT_ROOT / "libs" / "aja-core" / "aja" / "utils" / "agentx_guard.py",
