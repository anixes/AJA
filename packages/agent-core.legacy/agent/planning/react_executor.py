...
from agent.planning.models import PlanGraph, PlanNode
from agent.planning.scheduler import Scheduler
from agent.planning.execution_bridge import ExecutionBridge
from agent.planning.replanner import Replanner, RecoveryAction, RepairRecord
from agent.planning.plan_store import PlanStore
from agent.planning.version_store import VersionStore
...
class ReActExecutor:
    ...
    def run(self) -> bool:
        ...
        from agent.planning.verifier import verify_step
        from agent.runtime.event_bus import bus, EVENTS
        ...
        while True:
            ...
            for batch_idx, batch in enumerate(safe_batches):
                ...
                for node in batch:
                    ...
                    from agent.security.permissions import default_permissions
                    ...
                    if not success:
                        ...
                        from agent.planning.failure_classifier import classify_failure, FailureType
                        ...
                        from agent.planning.failure_memory import FailureMemory
