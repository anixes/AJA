...
class HandoverManager:
    ...
    def __init__(self):
        self.state_dir = PROJECT_ROOT / ".agent" / "handovers"
...
class BatonManager(HandoverManager):
    ...
    def __init__(self):
        super().__init__()
        self.baton_dir = PROJECT_ROOT / ".agent" / "batons"
    ...
    def pickup(self, code: str) -> Optional[Dict[str, Any]]:
        ...
        if "arrow_ref" in meta:
            ...
            if arrow_path.exists():
                ...
                rust_state = agent_native.read_baton(str(arrow_path))
