...
class DecisionEngine:
    ...
    * REJECT: objective is unsafe, malicious, or clearly invalid
    ...
    def decide(self, objective: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        similar_decisions = []
        try:
            from agent.decision.feedback import get_feedback_stats, get_similar_decisions
        ...
        try:
            from agent.decision.metrics import get_metrics_summary_for_prompt, get_metrics
