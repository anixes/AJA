...
def build_chain(
    ...
    """
    from agent.skills.skill_store import recommend_skill
...
def _skill_done(run_id: str, skill_id: str) -> bool:
    ...
    try:
        from agent.memory.manager import get_memory_manager, list_tables_defensive
...
def validate_chain(chain: list, max_steps: int = 10, simulate: bool = False) -> tuple:
    ...
    import importlib
    import json
    from agent.skills.skill_executor import check_environment
...
def compose_skills(
    ...
    - Never raises.
    """
    from agent.skills.skill_executor import execute_skill
    from agent.skills.skill_postconditions import validate_postconditions
    ...
    try:
        ...
        for position, (skill, sub_objective) in enumerate(chain):
            ...
            try:
                from agent.decision.evaluator import evaluate_pipeline
