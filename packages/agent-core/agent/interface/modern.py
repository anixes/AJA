"""
agent/interface/modern.py
==========================
Modern UI components for Agent CLI using 'rich'.
"""
...
# Custom theme for Assistant/Agent
ASSISTANT_THEME = Theme({
    "info": "cyan",
    "warning": "yellow",
    "error": "bold red",
    "success": "bold green",
...
def print_banner():
    console.print(Panel(Text(ASSISTANT_BANNER, justify="center", style="bold cyan"), border_style="cyan"))
...
def mission_spinner(objective: str):
    return Live(
        Panel(
            ...
            title="[bold cyan]Agent Swarm Engine[/]",
            border_style="cyan"
        ),
