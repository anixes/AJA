...
from agentx.decision.feedback import cleanup_old_decisions
...
def run_maintenance():
    ...
    while True:
        try:
            ...
            # (e.g. cleaning .agentx/batons/ older than 24h)
            ...
            try:
                import asyncio
                from agentx.autonomy.reflection import run_reflection
