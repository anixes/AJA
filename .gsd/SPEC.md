# AgentX Hybrid Architecture Specification

## Overview
AgentX is a high-performance autonomous orchestrator designed for local-first operations. It uses a hybrid architecture combining a Rust native core with a modular Python capability layer.

## Core Components

### 1. Native Core (agentx-native)
...
### 2. Orchestration Layer (agentx-core)
