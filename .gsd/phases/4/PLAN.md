...
## Objective
Enable AgentX to spawn specialized sub-agents and manage persistent tool connections via MCP.

## Wave 1: Native MCP Connectivity
- [ ] **Task 4.1: Implement MCPClient**
  - Create `packages/agentx-core/agentx/api/mcp_client.py`.
