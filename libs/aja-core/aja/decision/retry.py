...
def _pick_next_strategy(current_type: str) -> str:
    ...
    try:
        ...
        from aja.decision.convergence import score_strategies, get_blocked_strategies
...
def _lookup_causal_rule(error: str, result_text: str) -> Optional[str]:
    ...
    try:
        from aja.decision.rules import classify_failure, check_rules_for_failure
