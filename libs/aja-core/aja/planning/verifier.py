...
async def verify_plan_async(plan: PlanGraph, state: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    """
    Async mirror of verify_plan: DAG validation stays sync; the LLM call is awaited.
    """
...
Do not output any other text or markdown.
"""
        response = await completion_async(prompt, system_prompt="You are a strict logical verification agent.")
