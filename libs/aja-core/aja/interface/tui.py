"""
aja/interface/tui.py
========================
Premium TUI for AJA powered by AJA (Assistant of Joint Agents).
Refactored for 100% Pure AJA (Arrow/LanceDB memory).
"""
...
class AJAShell(App):
    ...
    def on_mount(self) -> None:
        ...
        self.log_aja("System online. AJA swarm is standing by.")
