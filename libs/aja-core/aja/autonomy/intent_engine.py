...
from aja.orchestration.router import execute_routed_node
...
class IntentEngine:
    ...
    def generate_intents(self, state: Dict[str, Any]) -> List[Intent]:
        ...
        candidates = [
            ...
            Intent("Optimize database performance", "optimize", benefit=0.7, risk=0.2, cost=0.3),
        ]
    ...
    def score_intent(self, intent: Intent) -> float:
        ...
        return (intent.benefit * intent.confidence) - intent.risk - intent.cost - penalty
