...
from aja.runtime.session import session_manager
from aja.runtime.event_bus import bus, EVENTS
import aja.config
from aja.runtime.broadcast import dispatch_broadcast
...
async def submit_task(req: TaskRequest):
    aja.config.AJA_DIVERSITY_BETA = (req.mode == "beta")
...
async def telegram_webhook(request: Request):
    from aja.scheduler.telegram import handle_telegram_message
    try:
